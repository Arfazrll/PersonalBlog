...
WAKATIME_API_KEY=your_wakatime_key`
    ...
    hardSkills: [
        ...
        { name: 'AI Modeling & Research', level: 'expert', category: 'ai' },
        { name: 'Data Engineering', level: 'advanced', category: 'data' },
        { name: 'Research Methodology', level: 'advanced', category: 'ai' },
        { name: 'Project Strategic Execution', level: 'expert', category: 'software' },
        { name: 'SDLC Management', level: 'advanced', category: 'software' },
